...
const promptSuggestion: {
    ...
    {
        title: 'อาชีพ | อยากสร้างอาชีพเพิ่ม สร้างให้หน่อย',
    ...
    {
        title: 'รายงาน | อยากดูว่ามีใครถูกรางวัลบ้าง',
    ...
    {
        title: 'รายงาน | แสดงคนในระบบหน่อย ตอนนี้มีกี่คนแล้ว',
        ...
        <div className="max-w-[900px] w-full mx-auto mt-20">
            <div>
                <div className="heading-text text-4xl leading-snug">
                    ...
                    <br />
                    <span>วันนี้มีอะไรให้ผมช่วย ?</span>
                </div>
