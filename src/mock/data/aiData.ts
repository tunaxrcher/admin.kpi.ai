...
export const imageData = [
  {
    id: '1',
    prompt:
      'While picnicking, you will see a beautiful image, a view of the sky, with shades of blue and fuchsia, observing the planets and stars.',
  ...
  },
  {
    id: '2',
    prompt:
      'Dark Text that says "Team LAL" with various cats and dogs in cartoon style in the background. Image background should be completely white ',
  ...
  },
  {
    id: '5',
    prompt:
      'create a broken jar in the style of this image and keep the african wax batik style and dip dye with crack effects.',
  ...
  },
  {
    id: '7',
    prompt:
      'make me a logo that will have a pink cat in it that will have a text "C2" below it',
  ...
  },
  {
    id: '9',
    prompt:
      'Create a realistic image of a 30 year old blonde women and a 30 year old man with black hair that are jumping from joy',
  ...
  },
  {
    id: '11',
    prompt:
      'Zodiac Sign Sagittarius: An Golden Retriever with sunglasses, shirt, cowboy-hat, in the Australia Sydney, exploring the desert at high noon. GTA loading screen style (warm tone) (golden hour)',
  ...
  },
  {
    id: '12',
    prompt:
      'A young woman sits cross-legged on her sofa. She plays the guitar gently. Colors and shapes escape.',
  ...
  },
  {
    id: '16',
    prompt:
      'generate me images for the theme of the birthday of a person named Fany and therefore the birthday is in June!!',
